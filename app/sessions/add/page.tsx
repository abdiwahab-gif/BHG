        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-1 font-sans text-balance">Add Academic Year</h1>
                <p className="text-muted-foreground text-base">Create a new academic session</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <span className="text-sm">Academic Session Setup</span>
            </motion.div>
          </div>
        </div>
      </motion.div>
