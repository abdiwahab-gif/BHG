...
import { IncomeFormCard } from "@/components/fundraising/income-form-card"
    ...
    >
        ...
        <div className="container mx-auto px-4 sm:px-6 py-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-foreground font-sans text-balance">Add Income</h1>
                <p className="text-muted-foreground text-base sm:text-lg">Record income amount and donor</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8">
        <div className="max-w-lg">
          <IncomeFormCard onSuccess={() => router.push("/fundraising/incomes")} />
        </div>
      </div>
    </motion.div>
  )
